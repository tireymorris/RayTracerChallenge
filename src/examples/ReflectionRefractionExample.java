...
public class ReflectionRefractionExample {
  public static void main(String[] args) {
    ...
    GlassSphere front = new GlassSphere();
    front.transform = Transform.identity().translate(0, 1.5, -4).scale(.45, .45, .45);
    ...
    Light light = Light.pointLight(new Point(0, 10, -10), new Color(1, 1, 1));
